...
if __name__ == "__main__":
    ...
    # Success! $100000 was withdrawn from test_account_id. The account's new balance is: $0.00
    # asyncpg.exceptions.SerializationError: could not serialize access due to concurrent update
    #   (This error was thrown on commit, not at business level as there was no lock)

    # The operation was processed only once
